...
execute if score #!same_item itemio.math.input matches 0 run function itemio:impl/container/input/custom/input_no_config/process_input/if_item/inf/fill with storage itemio:main.input temp.args