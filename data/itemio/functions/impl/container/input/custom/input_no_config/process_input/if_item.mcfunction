...
execute if data storage ioconfig[0].max_stack_size store result score #config_max_stack_size itemio.math.input run data get storage itemio:main.input ioconfig[0].max_stack_size
