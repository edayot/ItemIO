...
execute 
    ...
    run function ./nbt_items_repart:
        ...
        execute
            ...
            run data modify storage itemio:main.input nbt_items_path set from entity @s Item.tag.itemio.nbt_items_path
        execute
            if entity @s[type=armor_stand] 
            run data modify storage itemio:main.input nbt_items_path set from entity @s ArmorItems[3].tag.itemio.nbt_items_path
        execute
