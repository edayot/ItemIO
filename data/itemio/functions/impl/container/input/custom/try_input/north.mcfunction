...
execute if score #valid_item itemio.math matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{north:1b} run function itemio:impl/container/input/custom/repart
