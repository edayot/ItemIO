...
execute if score #filters.valid_item itemio.io matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{south:1b} run function itemio:impl/container/input/custom/repart
