...
execute if score #success_input itemio.io matches 0 positioned ~ ~ ~1 if block ~ ~ ~ #itemio:container/chests[facing=west,type=left] run function itemio:impl/container/input/vanilla/try_input