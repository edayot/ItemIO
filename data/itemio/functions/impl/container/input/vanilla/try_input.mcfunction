...
execute if score #needed_stack itemio.math.input <= #block_size itemio.math.input run function itemio:impl/container/input/vanilla/inf_insert
execute if score #needed_stack itemio.math.input > #block_size itemio.math.input run function itemio:impl/container/input/vanilla/sup_insert
