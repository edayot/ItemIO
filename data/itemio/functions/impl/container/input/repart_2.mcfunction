...
execute unless entity @e[tag=itemio.selected.input,tag=!itemio.container.nope,tag=!itemio.container.auto_handled_io] run function itemio:impl/container/input/vanilla/repart_vanilla
