...
execute if score #if_filters_defined2 itemio.math matches 0 if score #if_items_defined2 itemio.math matches 1 unless entity @s[tag=itemio.transfer.destination.already] run function itemio:impl/container/output/try_input_after/loop_items
execute if score #if_filters_defined2 itemio.math matches 0 if score #if_items_defined2 itemio.math matches 0 unless entity @s[tag=itemio.transfer.destination.already] run function itemio:impl/container/output/try_input_after/loop_normal
