...
execute if score #try_input_after itemio.math.output matches 1 if score #success_input itemio.math.input matches 0 if data storage itemio:main.output Items[0] run function itemio:impl/container/output/vanilla/normal/repart
