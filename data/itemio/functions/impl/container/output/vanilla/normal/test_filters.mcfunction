...
execute if score #filters.valid_item itemio.io matches 1 if score #success_output itemio.math.output matches 0 run function itemio:impl/container/output/vanilla/normal/output
