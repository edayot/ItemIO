...
execute if score #valid_item itemio.math matches 1 run function itemio:impl/container/output/custom/try_output/XXX/output
...
""".replace("XXX",str(i))
    ...
    print("execute if score #slot_output itemio.math.output matches XXX if data storage itemio:main.output Items[{Slot:XXXb}] run function itemio:impl/container/output/custom/try_output/XXX/test_nbt".replace("XXX",str(i)))
