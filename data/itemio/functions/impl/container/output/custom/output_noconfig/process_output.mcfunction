...
function ./remove_count_nbt_items:
    ...
    execute if entity @s[tag=itemio.container.nbt_items.on_passenger] on passengers run function ./real_remove_count_nbt_items with storage itemio:main.output temp.args_check_filters
    ...
    execute if entity @s[tag=!itemio.container.nbt_items.on_passenger,tag=!itemio.container.nbt_items.on_vehicle] run function ./real_remove_count_nbt_items with storage itemio:main.output temp.args_check_filters
