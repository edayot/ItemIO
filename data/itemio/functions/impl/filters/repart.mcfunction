...
execute if score #filter.valid_item itemio.io matches 1 if data storage itemio:io filter.merge as a97c9c67-fde0-4b89-926d-54fa4a866004 run function itemio:impl/filters/merge
execute if score #filter.valid_item itemio.io matches 1 if data storage itemio:io filter.item_predicate as a97c9c67-fde0-4b89-926d-54fa4a866004 run function itemio:impl/filters/item_predicate with storage itemio:io filter
