...
execute if score #filter.valid_item itemio.io matches 1 if data storage itemio:io filter.minecraft.bookshelf_books as 93682a08-d099-4e8f-a4a6-1e33a3692301 run function itemio:impl/filters/minecraft_bookshelf_books
