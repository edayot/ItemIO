...
data modify storage itemio:main temp.ctc2.id set from storage itemio:io item.components."minecraft:custom_data".ctc.id
...
data modify storage itemio:main temp.ctc2.from set from storage itemio:io item.components."minecraft:custom_data".ctc.from
