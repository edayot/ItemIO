...
execute if score #loaded itemio.math matches 1 run execute as @a[tag=convention.debug] run function itemio:impl/print_version
...
execute if score #loaded itemio.math matches 0 run schedule function itemio:impl/load_2 2t
