...
execute if score #valid_item itemio.math matches 0 if data storage itemio:main servo_items[0] run function itemio:impl/container/output/try_input_after/nbt_check
