...
execute as @e[tag=itemio.selected] run function itemio:working/custom/input
execute unless entity @e[tag=itemio.selected] if block ~ ~ ~ #itemio:container run function itemio:working/vanilla/input
