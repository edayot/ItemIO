...
execute unless entity @e[tag=itemio.selected.input,tag=!itemio.container.nope] if block ~ ~ ~ #itemio:container run function itemio:container/input/vanilla/input
