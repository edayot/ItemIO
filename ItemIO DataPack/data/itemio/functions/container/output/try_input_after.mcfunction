...
execute at @e[tag=itemio.transfer.destination,tag=!itemio.transfer.destination.already,limit=1,sort=nearest] run function itemio:container/output/try_input_after/loop
