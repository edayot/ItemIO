...
execute if score #valid_item itemio.math matches 0 run data remove storage itemio:main servo_filters[0]
execute if score #valid_item itemio.math matches 0 if data storage itemio:main servo_filters[0] run function itemio:container/output/try_input_after/filter