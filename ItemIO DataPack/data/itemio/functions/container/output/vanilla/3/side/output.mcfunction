...
execute unless score #try_input_after itemio.math.output matches 1 run item modify block ~ ~ ~ container.1 itemio:output/remove_count
execute if score #try_input_after itemio.math.output matches 1 run function itemio:container/output/vanilla/3/side/try_input_after