...
execute if score #!same_item itemio.math matches 1 run data remove storage itemio:main.output Items[0]
execute if score #!same_item itemio.math matches 1 if data storage itemio:main.output Items[0] run function itemio:container/output/vanilla/normal/test_nbt
