...
execute if score #success_output itemio.math matches 0 if data storage itemio:main.output ioconfig[0] run function itemio:container/output/custom/try_output_nocheck/bottom
