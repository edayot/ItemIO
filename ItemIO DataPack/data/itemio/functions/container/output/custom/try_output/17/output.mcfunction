...
execute if score #try_input_after itemio.math.output matches 0 run item modify block ~ ~ ~ container.17 itemio:output/remove_count
execute if score #try_input_after itemio.math.output matches 1 run function itemio:container/output/custom/try_output/17/try_input_after
