...
data modify storage itemio:main Item2 set from storage itemio:main Items[{Slot:14b}]
...
execute if score #!same_item itemio.math matches 0 run function itemio:container/output/custom/try_output/14/output
