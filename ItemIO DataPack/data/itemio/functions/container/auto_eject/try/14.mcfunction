...
data modify storage itemio:io input set from storage itemio:main Items2[{Slot:14b}]
...
execute if score #success_input itemio.math matches 1 run item modify block ~ ~ ~ container.14 itemio:input/remove_count_origin
