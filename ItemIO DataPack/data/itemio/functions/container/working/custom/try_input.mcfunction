...
execute if score #valid_item itemio.math matches 1 run function itemio:container/working/custom/repart
data remove storage itemio:main ioconfig[0]
execute if data storage itemio:main ioconfig[0] run function itemio:container/working/custom/try_input
