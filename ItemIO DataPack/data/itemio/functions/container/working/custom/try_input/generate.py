...
for i in range(3*9):
	print("""execute if score #full_input itemio.math matches 0 if score #slot itemio.math matches XXX run function itemio:container/working/custom/try_input/XXX/repart""".replace("XXX",str(i)))
	try:
		os.mkdir(str(i))
	except:
		pass
...
execute if score #if_item itemio.math matches 0 run function itemio:container/working/custom/try_input/XXX/unless_item
execute if score #if_item itemio.math matches 1 run function itemio:container/working/custom/try_input/XXX/if_item
...
execute if score #new_count_container itemio.math <= #full_stack itemio.math run function itemio:container/working/custom/try_input/XXX/if_item/inf/test_nbt
execute if score #new_count_container itemio.math > #full_stack itemio.math if score #count_container itemio.math < #full_stack itemio.math run function itemio:container/working/custom/try_input/XXX/if_item/sup/test_nbt
""".replace("XXX",str(i))
...
execute if score #!same_item itemio.math matches 0 run function itemio:container/working/custom/try_input/XXX/if_item/inf/fill
""".replace("XXX",str(i))
...
execute store success score #!same_item itemio.math run data modify storage itemio:main temp.Item1 set from storage itemio:main temp.Item2
execute if score #!same_item itemio.math matches 0 run function itemio:container/working/custom/try_input/XXX/if_item/sup/fill
""".replace("XXX",str(i))
