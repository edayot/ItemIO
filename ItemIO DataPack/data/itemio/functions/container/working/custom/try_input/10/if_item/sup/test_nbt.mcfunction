...
data modify storage itemio:main temp.Item2 set from storage itemio:main Items[{Slot:10b}]
...
execute if score #!same_item itemio.math matches 0 run function itemio:container/working/custom/try_input/10/if_item/sup/fill
