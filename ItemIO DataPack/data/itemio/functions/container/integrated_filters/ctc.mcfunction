...
execute if data storage itemio:io filter.ctc.from run function itemio:integrated_filters/working/ctc/check_from
execute if data storage itemio:io filter.ctc.id run function itemio:integrated_filters/working/ctc/check_id
