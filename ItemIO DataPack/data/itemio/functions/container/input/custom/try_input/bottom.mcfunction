...
execute if score #valid_item itemio.math.input matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{bottom:1b} run function itemio:container/input/custom/repart
