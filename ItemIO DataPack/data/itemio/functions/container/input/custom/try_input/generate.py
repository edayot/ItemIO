...
for i in range(3*9):
	print("""execute if score #full_input itemio.math.input matches 0 if score #slot itemio.math.input matches XXX run function itemio:container/input/custom/try_input/XXX/repart""".replace("XXX",str(i)))
	try:
		os.mkdir(str(i))
	except:
		pass
...
execute if score #if_item itemio.math.input matches 0 run function itemio:container/input/custom/try_input/XXX/unless_item
execute if score #if_item itemio.math.input matches 1 run function itemio:container/input/custom/try_input/XXX/if_item
...
execute if score #new_count_container itemio.math.input <= #full_stack itemio.math.input run function itemio:container/input/custom/try_input/XXX/if_item/inf/test_nbt
execute if score #new_count_container itemio.math.input > #full_stack itemio.math.input if score #count_container itemio.math.input < #full_stack itemio.math.input run function itemio:container/input/custom/try_input/XXX/if_item/sup/test_nbt
""".replace("XXX",str(i))
...
execute if score #!same_item itemio.math.input matches 0 run function itemio:container/input/custom/try_input/XXX/if_item/inf/fill
""".replace("XXX",str(i))
...
execute store success score #!same_item itemio.math.input run data modify storage itemio:main.input temp.Item1 set from storage itemio:main.input temp.Item2
execute if score #!same_item itemio.math.input matches 0 run function itemio:container/input/custom/try_input/XXX/if_item/sup/fill
""".replace("XXX",str(i))
