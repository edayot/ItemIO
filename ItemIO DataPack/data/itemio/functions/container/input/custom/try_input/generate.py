...
for i in range(3*9):
	print("""execute if score #full_input itemio.math matches 0 if score #slot itemio.math matches XXX run function itemio:container/input/custom/try_input/XXX/repart""".replace("XXX",str(i)))
	try:
		os.mkdir(str(i))
	except:
		pass
	...
	try:
		...
		pass
	repart="""execute store success score #if_item itemio.math if data storage itemio:main.input Items[{Slot:XXXb}]
execute if score #if_item itemio.math matches 0 run function itemio:container/input/custom/try_input/XXX/unless_item
execute if score #if_item itemio.math matches 1 run function itemio:container/input/custom/try_input/XXX/if_item
...
execute if score #count_input itemio.math <= #full_stack itemio.math run data modify block ~ ~ ~ Items append from storage itemio:main.input input
execute if score #count_input itemio.math <= #full_stack itemio.math run scoreboard players set #full_input itemio.math 1
execute if score #count_input itemio.math <= #full_stack itemio.math run data modify storage itemio:main.input input.Count set value 0b
...
execute if score #count_input itemio.math > #full_stack itemio.math store result storage itemio:main.input input.Count int 1 run scoreboard players get #new_count_input itemio.math
execute if score #count_input itemio.math > #full_stack itemio.math run data modify block ~ ~ ~ Items append from storage itemio:main.input input
...
""".replace("XXX",str(i))
	...
	if_item="""execute store result score #count_container itemio.math run data get storage itemio:main.input Items[{Slot:XXXb}].Count
execute store result score #count_input itemio.math run data get storage itemio:main.input input.Count
...
execute if score #new_count_container itemio.math <= #full_stack itemio.math run function itemio:container/input/custom/try_input/XXX/if_item/inf/test_nbt
execute if score #new_count_container itemio.math > #full_stack itemio.math if score #count_container itemio.math < #full_stack itemio.math run function itemio:container/input/custom/try_input/XXX/if_item/sup/test_nbt
""".replace("XXX",str(i))
...
execute store success score #!same_item itemio.math run data modify storage itemio:main.input temp.Item1 set from storage itemio:main.input temp.Item2
execute if score #!same_item itemio.math matches 0 run function itemio:container/input/custom/try_input/XXX/if_item/inf/fill
""".replace("XXX",str(i))
...
execute store success score #!same_item itemio.math run data modify storage itemio:main.input temp.Item1 set from storage itemio:main.input temp.Item2
execute if score #!same_item itemio.math matches 0 run function itemio:container/input/custom/try_input/XXX/if_item/sup/fill
""".replace("XXX",str(i))
	with open(str(i)+"/if_item/sup/test_nbt.mcfunction","w") as f:
		f.write(if_item_sup_test_nbt)

	if_item_sup_fill="""execute store result storage itemio:main.input Items[{Slot:XXXb}].Count byte 1 run scoreboard players get #full_stack itemio.math
