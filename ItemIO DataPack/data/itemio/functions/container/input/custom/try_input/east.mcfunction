...
execute if score #valid_item itemio.math.input matches 1 if data storage itemio:main.input ioconfig[0].allowed_side{east:1b} run function itemio:container/input/custom/repart
data remove storage itemio:main.input ioconfig[0]
execute if data storage itemio:main.input ioconfig[0] run function itemio:container/input/custom/try_input/east
