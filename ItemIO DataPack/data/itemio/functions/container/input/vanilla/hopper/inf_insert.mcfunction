...
loot insert ~ ~ ~ mine -30000000 22 1610 air{drop_contents:1b}
...
execute store result storage itemio:main input.Count int 1 run scoreboard players get #count_input itemio.math
