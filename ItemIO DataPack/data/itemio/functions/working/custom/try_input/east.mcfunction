...
execute if score #valid_item itemio.math matches 1 if data storage itemio:main ioconfig[0].allowed_side{east:1b} run function itemio:working/custom/repart
