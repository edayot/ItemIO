...
execute if block ~ ~ ~ #itemio:container/27 run function itemio:working/vanilla/27/try_input
execute if block ~ ~ ~ #itemio:container/9 run function itemio:working/vanilla/9/try_input
execute if block ~ ~ ~ #itemio:container/3 run function itemio:working/vanilla/3/try_input
