...
execute as @e[tag=itemio.transfer.destination,tag=!itemio.transfer.destination.already] unless entity @s[distance=..0.5] run tag @s add itemio.transfer.destination.good_distance
