...
execute if block ~ ~ ~ #itemio:container/normal run function itemio:v0.0.1/container/output/vanilla/normal/repart
execute if block ~ ~ ~ #itemio:container/3 run function itemio:v0.0.1/container/output/vanilla/3/repart
