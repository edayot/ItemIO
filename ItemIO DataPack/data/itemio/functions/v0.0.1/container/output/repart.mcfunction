...
execute as @e[tag=itemio.selected.output,tag=!itemio.container.nope,tag=!itemio.auto_handled_io] run function itemio:v0.0.1/container/output/custom/output
execute unless entity @e[tag=itemio.selected.output,tag=!itemio.container.nope,tag=!itemio.auto_handled_io] if block ~ ~ ~ #itemio:container run function itemio:v0.0.1/container/output/vanilla/test_output
