...
execute at @s align xyz run summon marker ~.5 ~.5 ~.5 {data:{itemio:{ioconfig:{input_side:"east"}}},Tags:["itemio.transfer.destination","itemio.transfer.destination.temp","itemio.summoned"]}
