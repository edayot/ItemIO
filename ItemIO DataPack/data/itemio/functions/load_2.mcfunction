...
execute if score #loaded itemio.math matches 1 run setblock -30000000 20 1610 yellow_shulker_box
...
execute if score #loaded itemio.math matches 0 run schedule function itemio:load_2 5t
